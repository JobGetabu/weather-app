package com.cellulant.weather.ui.activity;
...
import com.cellulant.weather.R;
import com.cellulant.weather.databinding.ActivityMainBinding;
import com.cellulant.weather.model.CityInfo;
import com.cellulant.weather.model.currentweather.CurrentWeatherResponse;
import com.cellulant.weather.model.daysweather.ListItem;
import com.cellulant.weather.model.daysweather.MultipleDaysWeatherResponse;
import com.cellulant.weather.model.db.CurrentWeather;
import com.cellulant.weather.model.db.FavoriteWeather;
import com.cellulant.weather.model.db.FiveDayWeather;
import com.cellulant.weather.model.db.ItemHourlyDB;
import com.cellulant.weather.model.fivedayweather.FiveDayResponse;
import com.cellulant.weather.model.fivedayweather.ItemHourly;
import com.cellulant.weather.model.one_call.Root;
import com.cellulant.weather.service.ApiService;
import com.cellulant.weather.ui.fragment.CityInfoFragment;
import com.cellulant.weather.utils.ApiClient;
import com.cellulant.weather.utils.AppUtil;
import com.cellulant.weather.utils.Constants;
import com.cellulant.weather.utils.DbUtil;
import com.cellulant.weather.utils.MyApplication;
import com.cellulant.weather.utils.SnackbarUtil;
import com.cellulant.weather.utils.TextViewFactory;
                ...
                .observer(new DataObserver<List<CurrentWeather>>() {
                    ...
                    public void onData(@NonNull List<CurrentWeather> data) {
                        if (data.size() > 0) {
                            ...
                            newCalendar.setTimeInMillis(currentWeather.getStoreTimestamp());
                            ...
                            if (isLoad) {
                                ...
                                binding.contentMainLayout.windTextView.setText("Wind deg: " + currentWeather.getWindDeg());
                                binding.contentMainLayout.humidityTextView.setText("Humidity: " + currentWeather.getHumidity() + "%");
                                binding.contentMainLayout.pressureTextView.setText("Wind speed: " + currentWeather.getWindSpeed());
                                binding.contentMainLayout.minTextView.setText("Min temp: " + String.format(Locale.getDefault(), "%.0f°", currentWeather.getMaxTemp()));
                                binding.contentMainLayout.maxTextView.setText("Max temp: " + String.format(Locale.getDefault(), "%.0f°", currentWeather.getMinTemp()));
                                ...
                                binding.contentMainLayout.lastUpdateTextView.setText("Last update: \n" + format1.format(newCalendar.getTime()));
